...
const PaymentMethods = () => {
  return (
    <div className="paymentMethodBgImage h-[80vh] bg-black w-full text-white pt-10 flex flex-col items-center px-6 md:px-0 ">
      <p className="font-[600] text-[32px] md:text-[46px] text-center ">
        Payment methods
      </p>
      <p className="text-center text-[18px] w-full md:w-[60%] ">

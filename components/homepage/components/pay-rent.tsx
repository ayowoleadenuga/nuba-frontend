...
const PayRent = () => {
  return (
    <div className="payRentBgImage h-[70vh] bg-black w-full text-white pt-10 flex flex-col items-start md:items-center px-6 md:px-0 ">
      <p className="font-[600] text-[32px] md:text-[48px]  ">
        Pay rent easily, anytime, anywhere.
      </p>
      <p className=" text-[18px] w-full md:w-[58%] ">
